...
interface OvershootManager {
   ...
   */
  fun getOvershoots(flow: Flow, mouseMovementMs: Long, distance: Double): Int
   ...
   */
  fun getOvershootAmount(distanceToRealTargetX: Double, distanceToRealTargetY: Double, mouseMovementMs: Long, overshootsRemaining: Int): Point
   ...
   */
  fun deriveNextMouseMovementTimeMs(mouseMovementMs: Long, overshootsRemaining: Int): Long
}
